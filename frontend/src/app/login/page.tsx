...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-background-base overflow-hidden">
      {/* Gradient glow */}
      <div
      ...
      <div className="relative w-full max-w-md px-6">
        <div className="bg-background-surface/80 backdrop-blur-xl border border-border-default rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-3">
            <Button size="lg" className="w-full animate-pulseGlow" onClick={() => login('google')}>
